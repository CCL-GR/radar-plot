...
for line in fileinput.input(sys.argv[1]):
    ...
    stat_visual_spacial = line.split(sep=' ')[3],
    stat_introspective =line.split(sep=' ')[4],
    stat_social = line.split(sep=' ')[5],
    stat_verbal = line.split(sep=' ')[6],
    stat_logical = line.split(sep=' ')[7],
    stat_musical = line.split(sep=' ')[8],
    stat_body = line.split(sep=' ')[9],
    stat_nature = line.split(sep=' ')[10],
